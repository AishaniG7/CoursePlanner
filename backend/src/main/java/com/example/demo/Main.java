...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print("Enter your completed Course in a comma delimited list: ");
        ...
        while (scanner.hasNext()) {
            ...
            completedCourses.add(token);
        }

        System.out.println("Enter your standing: ");
        int standing = scnr.nextInt();


        List<String> classes = new ArrayList<>();
        classes = getEligibleclasses(completedCourses, prereqGraph);
        ...
        System.out.println("Recommended Curated Classes: ");
        List<String> curatedList = giveRecommendedClasssesBasedOnYear(classes,standing,completedCourses);
        for (String course : curatedList) {
            System.out.println(course);
        }
